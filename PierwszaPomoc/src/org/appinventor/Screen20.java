...
class Screen20 extends Form implements HandlesEventDispatching {
  ...
  protected void $define() {
    ...
    Label2.Width(-1098);
    Label2.Row(0);
    Label2.Text("RKO NIEMOWLĘ");
    Label3 = new Label(TableArrangement1);
    Label3.Column(0);
    Label3.Height(-1007);
    Label3.Width(-1098);
    Label3.Row(1);
    Label3.Text("Na dworcu kolejowych zauważasz leżące niemowlę, co robisz?");
    Image3 = new Image(TableArrangement1);
    Image3.Column(0);
    Image3.Height(-1062);
    Image3.Width(270);
    Image3.Picture("RKONIEMOWLAKA.png");
    Image3.Row(2);
