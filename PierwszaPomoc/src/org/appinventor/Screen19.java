...
class Screen19 extends Form implements HandlesEventDispatching {
  ...
  protected void $define() {
    ...
    Label2.Width(-1098);
    Label2.Row(0);
    Label2.Text("RKO DZIECKO");
    Label3 = new Label(TableArrangement1);
    Label3.Column(0);
    Label3.Row(1);
    Label3.Text("Na boisku zauważasz leżącego chłopca, co robisz?");
    Image3 = new Image(TableArrangement1);
    Image3.Column(0);
    Image3.Height(-1055);
    Image3.Width(250);
    Image3.Picture("RKODZIECKA.png");
    Image3.Row(2);
