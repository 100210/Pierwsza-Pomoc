...
class Screen21 extends Form implements HandlesEventDispatching {
  ...
  protected void $define() {
    ...
    Label2.Width(-1098);
    Label2.Row(0);
    Label2.Text("RKO DOROSŁEGO Z AED");
    Label3 = new Label(TableArrangement1);
    Label3.Column(0);
    Label3.Row(1);
    Label3.Text("Na chodniku zauważasz leżącego mężczyzne co robisz?");
    Image3 = new Image(TableArrangement1);
    Image3.Column(0);
    Image3.Height(-1060);
    Image3.Width(300);
    Image3.Picture("RKODOROSLYAED.png");
    Image3.Row(2);
